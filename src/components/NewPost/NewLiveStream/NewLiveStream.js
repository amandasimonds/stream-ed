...
class NewLiveStream extends Component {
    ...
    postDataHandler = () => {
        ...
        axios.post("/liveStreams.json", data)
            .then(response => {
        ...
        return (
            <Layout>
                ...
                <div className={classes.NewPost}>
                    ...
                    Live Stream Time:
                    <input type="time" id="appt" name="appt" min="08:00" max="18:00" required onChange={(event) => this.setState({ time: event.target.value })}></input>
